    ...
    <footer className="border-t border-[var(--border)] bg-[var(--bg)]">
      <div className="max-w-6xl mx-auto px-5 py-14 grid sm:grid-cols-2 md:grid-cols-4 gap-10">
        <div className="col-span-2 md:col-span-1">
          ...
          <p className="text-sm text-[var(--fg-muted)] leading-relaxed">The AI Resume Builder — build resumes that get you more offers.</p>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-2.5 text-sm">
            ...
            <Link href="/resumeanalyser" className="text-[var(--fg-muted)] hover:text-[var(--fg)] transition-colors">Resume analyser</Link>
