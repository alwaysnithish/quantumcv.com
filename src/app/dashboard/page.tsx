...
// Always render this page fresh on every request/navigation — without this,
// Next.js can serve a cached RSC payload (e.g. when returning from /builder
// after a resume finishes generating), which is why stats like "Generated"
// could appear stuck at an old value.
