...
export async function PATCH(request: NextRequest, { params }: Params) {
  ...
  // Saving generated content is what makes a resume "generated". Once a
  // resume has ever been exported we leave it as 'exported' — a later edit
  // shouldn't demote it back down and make the export stat lie.
  const hasGeneratedData = Boolean(data.generated_data ?? resume.generatedData);
  const nextStatus =
